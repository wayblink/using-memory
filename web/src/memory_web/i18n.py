...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dashboard.savings.anatomy": "Anatomy injected",
        "dashboard.savings.anatomy.hint": "Tokens auto-attached at SessionStart, sparing the model from re-discovering project layout.",
    ...
    "zh": {
        ...
        "dashboard.savings.anatomy": "Anatomy 注入",
        "dashboard.savings.anatomy.hint": "SessionStart 自动 attach 的 tokens，省去模型重新探索项目结构。",
