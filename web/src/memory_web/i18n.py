...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dashboard.anatomy_section": "Anatomy",
        ...
        "dashboard.maintain.summary": "stale {stale} · corrupt {corrupt} · repaired {repaired} · broken refs {broken} · anatomy drift {drift}",
        # Logs
        "logs.title": "Logs",
    ...
    "zh": {
        ...
        "dashboard.anatomy_section": "项目快照",
        "dashboard.never": "（无）",
        ...
        "dashboard.maintain.summary": "陈旧 {stale} · 损坏 {corrupt} · 已修复 {repaired} · 失效引用 {broken} · 快照漂移 {drift}",
        # Logs
        "logs.title": "日志",
        "logs.sub": "{n} 条 · 按时间倒序",
        "logs.form.from": "起始",
